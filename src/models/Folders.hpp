...
public:
  struct Cols {
    ...
    static const std::string _depth;
    static const std::string _item_count;
   ...
   */
  explicit Folders(const drogon::orm::Row &r,
   ...
   */
  explicit Folders(const Json::Value &pJson) noexcept(false);
   ...
   */
  Folders(const Json::Value &pJson,
  ...
  /// Get the value of the column parent_id, returns the default value if the
  /// column is null
  ...
  /**  For column depth  */
  /// Get the value of the column depth, returns the default value if the column
  /// is null
  const int32_t &getValueOfDepth() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<int32_t> &getDepth() const noexcept;
  /// Set the value of the column depth
  void setDepth(const int32_t &pDepth) noexcept;

  /**  For column item_count  */
  /// Get the value of the column item_count, returns the default value if the
  /// column is null
  const int32_t &getValueOfItemCount() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<int32_t> &getItemCount() const noexcept;
  /// Set the value of the column item_count
  void setItemCount(const int32_t &pItemCount) noexcept;
...
private:
  friend drogon::orm::Mapper<Folders>;
  friend drogon::orm::BaseBuilder<Folders, true, true>;
  friend drogon::orm::BaseBuilder<Folders, true, false>;
  friend drogon::orm::BaseBuilder<Folders, false, true>;
  friend drogon::orm::BaseBuilder<Folders, false, false>;
#ifdef __cpp_impl_coroutine
  friend drogon::orm::CoroMapper<Folders>;
#endif
  ...
  std::shared_ptr<int32_t> depth_;
  std::shared_ptr<int32_t> itemCount_;
