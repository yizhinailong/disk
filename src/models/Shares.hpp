...
public:
   ...
   */
  explicit Shares(const drogon::orm::Row &r,
  ...
  /// Get the value of the column share_code, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column permission, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column view_count, returns the default value if the
  /// column is null
