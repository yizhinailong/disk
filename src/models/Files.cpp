...
Files::Files(const Row &r, const ssize_t indexOffset) noexcept {
  if (indexOffset < 0) {
    ...
    if (!r["extension"].isNull()) {
      extension_ =
          std::make_shared<std::string>(r["extension"].as<std::string>());
    }
    if (!r["size"].isNull()) {
    ...
    if (!r["is_favorite"].isNull()) {
      isFavorite_ = std::make_shared<short>(r["is_favorite"].as<short>());
    }
    ...
    index = offset + 9;
    if (!r[index].isNull()) {
      isFavorite_ = std::make_shared<short>(r[index].as<short>());
    }
    index = offset + 10;
    if (!r[index].isNull()) {
...
Files::Files(
  ...
  if (!pMasqueradingVector[5].empty() &&
    ...
    if (!pJson[pMasqueradingVector[5]].isNull()) {
      extension_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[9].empty() &&
    ...
    if (!pJson[pMasqueradingVector[9]].isNull()) {
      isFavorite_ = std::make_shared<short>(
...
Files::Files(const Json::Value &pJson) noexcept(false) {
  ...
  if (pJson.isMember("is_favorite")) {
    ...
    if (!pJson["is_favorite"].isNull()) {
      isFavorite_ =
          std::make_shared<short>((short)pJson["is_favorite"].asInt64());
    }
  }
...
void Files::updateByMasqueradedJson(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false) {
  if (pMasqueradingVector.size() != 14) {
    LOG_ERROR << "Bad masquerading vector";
...
const std::shared_ptr<int64_t> &Files::getId() const noexcept { return id_; }
...
const int64_t &Files::getValueOfUserId() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (userId_)
    return *userId_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Files::getUserId() const noexcept {
  return userId_;
}
void Files::setUserId(const int64_t &pUserId) noexcept {
  userId_ = std::make_shared<int64_t>(pUserId);
  dirtyFlag_[1] = true;
}

const int64_t &Files::getValueOfContentId() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (contentId_)
    return *contentId_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Files::getContentId() const noexcept {
  return contentId_;
}
void Files::setContentId(const int64_t &pContentId) noexcept {
  contentId_ = std::make_shared<int64_t>(pContentId);
  dirtyFlag_[2] = true;
}

const int64_t &Files::getValueOfFolderId() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (folderId_)
    return *folderId_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Files::getFolderId() const noexcept {
  return folderId_;
}
void Files::setFolderId(const int64_t &pFolderId) noexcept {
...
const int64_t &Files::getValueOfSize() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (size_)
    return *size_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Files::getSize() const noexcept {
  return size_;
}
void Files::setSize(const int64_t &pSize) noexcept {
...
const short &Files::getValueOfIsFavorite() const noexcept {
  static const short defaultValue = short();
  if (isFavorite_)
    return *isFavorite_;
  return defaultValue;
}
const std::shared_ptr<short> &Files::getIsFavorite() const noexcept {
  return isFavorite_;
}
void Files::setIsFavorite(const short &pIsFavorite) noexcept {
  isFavorite_ = std::make_shared<short>(pIsFavorite);
  dirtyFlag_[9] = true;
}

const int32_t &Files::getValueOfDownloadCount() const noexcept {
  static const int32_t defaultValue = int32_t();
  if (downloadCount_)
    return *downloadCount_;
  return defaultValue;
}
const std::shared_ptr<int32_t> &Files::getDownloadCount() const noexcept {
  return downloadCount_;
}
void Files::setDownloadCount(const int32_t &pDownloadCount) noexcept {
...
Files::getLastAccessedAt() const noexcept {
  return lastAccessedAt_;
}
...
const std::vector<std::string> &Files::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {
      "user_id",     "content_id",     "folder_id",        "name",
      "extension",   "size",           "mime_type",        "path",
      "is_favorite", "download_count", "last_accessed_at", "created_at",
      "updated_at"};
  return inCols;
}
...
Json::Value Files::toMasqueradedJson(
  ...
  if (pMasqueradingVector.size() == 14) {
    ...
    if (!pMasqueradingVector[3].empty()) {
      if (getFolderId()) {
        ret[pMasqueradingVector[3]] = (Json::Int64)getValueOfFolderId();
      } else {
    ...
    if (!pMasqueradingVector[6].empty()) {
      if (getSize()) {
        ret[pMasqueradingVector[6]] = (Json::Int64)getValueOfSize();
      } else {
...
bool Files::validateJsonForCreation(const Json::Value &pJson,
                                    std::string &err) {
  if (pJson.isMember("id")) {
  ...
  if (pJson.isMember("download_count")) {
    if (!validJsonOfField(10, "download_count", pJson["download_count"], err,
                          true))
      return false;
  }
  if (pJson.isMember("last_accessed_at")) {
    if (!validJsonOfField(11, "last_accessed_at", pJson["last_accessed_at"],
                          err, true))
      return false;
  }
  if (pJson.isMember("created_at")) {
...
bool Files::validateMasqueradedJsonForCreation(
    const Json::Value &pJson,
...
bool Files::validateMasqueradedJsonForUpdate(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector, std::string &err) {
  if (pMasqueradingVector.size() != 14) {
    err = "Bad masquerading vector";
...
bool Files::validJsonOfField(size_t index, const std::string &fieldName,
