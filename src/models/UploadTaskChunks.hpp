...
public:
  ...
  using PrimaryKeyType = std::tuple<std::string, int32_t>; // task_id,chunk_index
   ...
   */
  explicit UploadTaskChunks(const drogon::orm::Row &r,
  ...
  /**  For column task_id  */
  /// Get the value of the column task_id, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column chunk_index, returns the default value if the
  /// column is null
  const int32_t &getValueOfChunkIndex() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<int32_t> &getChunkIndex() const noexcept;
  /// Set the value of the column chunk_index
  void setChunkIndex(const int32_t &pChunkIndex) noexcept;

  /**  For column uploaded_at  */
  /// Get the value of the column uploaded_at, returns the default value if the
  /// column is null
...
private:
  ...
  std::shared_ptr<int32_t> chunkIndex_;
...
public:
  ...
  static const std::string &sqlForDeletingByPrimaryKey() {
    static const std::string sql =
        "delete from " + tableName + " where task_id = $1 and chunk_index = $2";
    return sql;
  }
