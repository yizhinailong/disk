...
public:
   ...
   */
  explicit OperationLogs(const drogon::orm::Row &r,
  ...
  /**  For column action  */
  /// Get the value of the column action, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column target_type, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column target_id, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column target_name, returns the default value if the
  /// column is null
  ...
  /**  For column details  */
  /// Get the value of the column details, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column ip_address, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column user_agent, returns the default value if the
  /// column is null
