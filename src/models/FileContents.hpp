...
public:
   ...
   */
  explicit FileContents(const drogon::orm::Row &r,
  ...
  /**  For column hash_md5  */
  /// Get the value of the column hash_md5, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column hash_sha256, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column storage_path, returns the default value if the
  /// column is null
  ...
  /// Get the value of the column ref_count, returns the default value if the
  /// column is null
  const int32_t &getValueOfRefCount() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<int32_t> &getRefCount() const noexcept;
  /// Set the value of the column ref_count
  void setRefCount(const int32_t &pRefCount) noexcept;
...
private:
  ...
  std::shared_ptr<int32_t> refCount_;
