...
Users::Users(const Json::Value& pJson, const std::vector<std::string>& pMasqueradingVector) noexcept(false) {
    ...
    if (!pMasqueradingVector[9].empty() && pJson.isMember(pMasqueradingVector[9])) {
        ...
        if (!pJson[pMasqueradingVector[9]].isNull()) {
            loginAttempts_ = std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[9]].asInt64());
        }
    }
    ...
    if (!pMasqueradingVector[12].empty() && pJson.isMember(pMasqueradingVector[12])) {
        ...
        if (!pJson[pMasqueradingVector[12]].isNull()) {
            lastLoginIp_ = std::make_shared<std::string>(pJson[pMasqueradingVector[12]].asString());
        }
    }
...
Json::Value Users::toMasqueradedJson(
    ...
    if (pMasqueradingVector.size() == 15) {
        ...
        if (!pMasqueradingVector[9].empty()) {
            if (getLoginAttempts()) {
                ret[pMasqueradingVector[9]] = getValueOfLoginAttempts();
            } else {
        ...
        if (!pMasqueradingVector[10].empty()) {
            if (getLockedUntil()) {
                ret[pMasqueradingVector[10]] = getLockedUntil()->toDbStringLocal();
            } else {
        ...
        if (!pMasqueradingVector[11].empty()) {
            if (getLastLoginAt()) {
                ret[pMasqueradingVector[11]] = getLastLoginAt()->toDbStringLocal();
            } else {
        ...
        if (!pMasqueradingVector[12].empty()) {
            if (getLastLoginIp()) {
                ret[pMasqueradingVector[12]] = getValueOfLastLoginIp();
            } else {
...
bool Users::validateJsonForCreation(const Json::Value& pJson, std::string& err) {
    ...
    if (pJson.isMember("login_attempts")) {
        if (!validJsonOfField(9, "login_attempts", pJson["login_attempts"], err, true)) {
            return false;
        }
    }
    if (pJson.isMember("locked_until")) {
        if (!validJsonOfField(10, "locked_until", pJson["locked_until"], err, true)) {
            return false;
        }
    }
    if (pJson.isMember("last_login_at")) {
        if (!validJsonOfField(11, "last_login_at", pJson["last_login_at"], err, true)) {
            return false;
        }
    }
    if (pJson.isMember("last_login_ip")) {
        if (!validJsonOfField(12, "last_login_ip", pJson["last_login_ip"], err, true)) {
            return false;
        }
    }
    if (pJson.isMember("created_at")) {
...
bool Users::validateJsonForUpdate(const Json::Value& pJson, std::string& err) {
    ...
    if (pJson.isMember("login_attempts")) {
        if (!validJsonOfField(9, "login_attempts", pJson["login_attempts"], err, false)) {
            return false;
        }
    }
    if (pJson.isMember("locked_until")) {
        if (!validJsonOfField(10, "locked_until", pJson["locked_until"], err, false)) {
            return false;
        }
    }
    if (pJson.isMember("last_login_at")) {
        if (!validJsonOfField(11, "last_login_at", pJson["last_login_at"], err, false)) {
            return false;
        }
    }
    if (pJson.isMember("last_login_ip")) {
        if (!validJsonOfField(12, "last_login_ip", pJson["last_login_ip"], err, false)) {
            return false;
        }
    }
    if (pJson.isMember("created_at")) {
