...
const std::vector<typename Users::MetaData> Users::metaData_ = {
    ...
    {"nickname", "std::string", "character varying", 64, 0, 0, 0},
    {"avatar", "std::string", "character varying", 512, 0, 0, 0},
    {"storage_quota", "int64_t", "bigint", 8, 0, 0, 1},
    {"storage_used", "int64_t", "bigint", 8, 0, 0, 1},
    {"storage_reserved", "int64_t", "bigint", 8, 0, 0, 1},
    {"status", "short", "smallint", 2, 0, 0, 1},
    {"role", "short", "smallint", 2, 0, 0, 1},
    {"login_attempts", "int32_t", "integer", 4, 0, 0, 1},
    {"locked_until", "::trantor::Date", "timestamp without time zone", 0, 0, 0,
     0},
    {"last_login_at", "::trantor::Date", "timestamp without time zone", 0, 0, 0,
     0},
    {"last_login_ip", "std::string", "character varying", 45, 0, 0, 0},
...
Users::Users(const Row &r, const ssize_t indexOffset) noexcept {
  if (indexOffset < 0) {
    ...
    if (!r["nickname"].isNull()) {
      nickname_ =
          std::make_shared<std::string>(r["nickname"].as<std::string>());
    }
    if (!r["avatar"].isNull()) {
    ...
    if (!r["storage_quota"].isNull()) {
      storageQuota_ =
          std::make_shared<int64_t>(r["storage_quota"].as<int64_t>());
    }
    if (!r["storage_used"].isNull()) {
      storageUsed_ = std::make_shared<int64_t>(r["storage_used"].as<int64_t>());
    }
    if (!r["storage_reserved"].isNull()) {
      storageReserved_ =
          std::make_shared<int64_t>(r["storage_reserved"].as<int64_t>());
    }
    if (!r["status"].isNull()) {
      status_ = std::make_shared<short>(r["status"].as<short>());
    }
    if (!r["role"].isNull()) {
      role_ = std::make_shared<short>(r["role"].as<short>());
    }
    if (!r["login_attempts"].isNull()) {
      loginAttempts_ =
          std::make_shared<int32_t>(r["login_attempts"].as<int32_t>());
    }
    ...
    if (!r["last_login_ip"].isNull()) {
      lastLoginIp_ =
          std::make_shared<std::string>(r["last_login_ip"].as<std::string>());
    }
    ...
    index = offset + 6;
    if (!r[index].isNull()) {
      storageQuota_ = std::make_shared<int64_t>(r[index].as<int64_t>());
    }
    index = offset + 7;
    if (!r[index].isNull()) {
      storageUsed_ = std::make_shared<int64_t>(r[index].as<int64_t>());
    }
    index = offset + 8;
    if (!r[index].isNull()) {
      storageReserved_ = std::make_shared<int64_t>(r[index].as<int64_t>());
    }
    index = offset + 9;
    if (!r[index].isNull()) {
    ...
    index = offset + 10;
    if (!r[index].isNull()) {
      role_ = std::make_shared<short>(r[index].as<short>());
    }
    index = offset + 11;
    if (!r[index].isNull()) {
...
Users::Users(
  ...
  if (!pMasqueradingVector[4].empty() &&
    ...
    if (!pJson[pMasqueradingVector[4]].isNull()) {
      nickname_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[5].empty() &&
    ...
    if (!pJson[pMasqueradingVector[5]].isNull()) {
      avatar_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[6].empty() &&
    ...
    if (!pJson[pMasqueradingVector[6]].isNull()) {
      storageQuota_ = std::make_shared<int64_t>(
  ...
  if (!pMasqueradingVector[7].empty() &&
    ...
    if (!pJson[pMasqueradingVector[7]].isNull()) {
      storageUsed_ = std::make_shared<int64_t>(
  ...
  if (!pMasqueradingVector[8].empty() &&
    ...
    if (!pJson[pMasqueradingVector[8]].isNull()) {
      storageReserved_ = std::make_shared<int64_t>(
  ...
  if (!pMasqueradingVector[9].empty() &&
    ...
    if (!pJson[pMasqueradingVector[9]].isNull()) {
      status_ = std::make_shared<short>(
          (short)pJson[pMasqueradingVector[9]].asInt64());
    }
  }
  ...
  if (!pMasqueradingVector[11].empty() &&
    ...
    if (!pJson[pMasqueradingVector[11]].isNull()) {
      loginAttempts_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[14].empty() &&
    ...
    if (!pJson[pMasqueradingVector[14]].isNull()) {
      lastLoginIp_ = std::make_shared<std::string>(
  ...
  if (!pMasqueradingVector[16].empty() &&
      pJson.isMember(pMasqueradingVector[16])) {
    dirtyFlag_[16] = true;
...
Users::Users(const Json::Value &pJson) noexcept(false) {
  ...
  if (pJson.isMember("storage_quota")) {
    ...
    if (!pJson["storage_quota"].isNull()) {
      storageQuota_ =
          std::make_shared<int64_t>((int64_t)pJson["storage_quota"].asInt64());
    }
  }
  if (pJson.isMember("storage_used")) {
    ...
    if (!pJson["storage_used"].isNull()) {
      storageUsed_ =
          std::make_shared<int64_t>((int64_t)pJson["storage_used"].asInt64());
    }
  }
  if (pJson.isMember("storage_reserved")) {
    ...
    if (!pJson["storage_reserved"].isNull()) {
      storageReserved_ = std::make_shared<int64_t>(
          (int64_t)pJson["storage_reserved"].asInt64());
    }
  }
  ...
  if (pJson.isMember("role")) {
    ...
    if (!pJson["role"].isNull()) {
      role_ = std::make_shared<short>((short)pJson["role"].asInt64());
    }
  }
  if (pJson.isMember("login_attempts")) {
    ...
    if (!pJson["login_attempts"].isNull()) {
      loginAttempts_ =
          std::make_shared<int32_t>((int32_t)pJson["login_attempts"].asInt64());
    }
  }
  ...
  if (pJson.isMember("last_login_ip")) {
    ...
    if (!pJson["last_login_ip"].isNull()) {
      lastLoginIp_ =
          std::make_shared<std::string>(pJson["last_login_ip"].asString());
    }
  }
...
const int64_t &Users::getValueOfStorageQuota() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (storageQuota_)
    return *storageQuota_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Users::getStorageQuota() const noexcept {
  return storageQuota_;
}
void Users::setStorageQuota(const int64_t &pStorageQuota) noexcept {
  storageQuota_ = std::make_shared<int64_t>(pStorageQuota);
  dirtyFlag_[6] = true;
}

const int64_t &Users::getValueOfStorageUsed() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (storageUsed_)
    return *storageUsed_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Users::getStorageUsed() const noexcept {
  return storageUsed_;
}
void Users::setStorageUsed(const int64_t &pStorageUsed) noexcept {
  storageUsed_ = std::make_shared<int64_t>(pStorageUsed);
  dirtyFlag_[7] = true;
}

const int64_t &Users::getValueOfStorageReserved() const noexcept {
  static const int64_t defaultValue = int64_t();
  if (storageReserved_)
    return *storageReserved_;
  return defaultValue;
}
const std::shared_ptr<int64_t> &Users::getStorageReserved() const noexcept {
  return storageReserved_;
}
void Users::setStorageReserved(const int64_t &pStorageReserved) noexcept {
  storageReserved_ = std::make_shared<int64_t>(pStorageReserved);
  dirtyFlag_[8] = true;
}

const short &Users::getValueOfStatus() const noexcept {
  static const short defaultValue = short();
  if (status_)
    return *status_;
  return defaultValue;
}
const std::shared_ptr<short> &Users::getStatus() const noexcept {
  return status_;
}
void Users::setStatus(const short &pStatus) noexcept {
  status_ = std::make_shared<short>(pStatus);
  dirtyFlag_[9] = true;
}

const short &Users::getValueOfRole() const noexcept {
  static const short defaultValue = short();
  if (role_)
    return *role_;
  return defaultValue;
}
const std::shared_ptr<short> &Users::getRole() const noexcept { return role_; }
void Users::setRole(const short &pRole) noexcept {
  role_ = std::make_shared<short>(pRole);
  dirtyFlag_[10] = true;
}
...
const std::vector<std::string> &Users::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {
      ...
      "avatar",        "storage_quota", "storage_used",   "storage_reserved",
      "status",        "role",          "login_attempts", "locked_until",
...
Json::Value Users::toJson() const {
  ...
  if (getStorageQuota()) {
    ret["storage_quota"] = (Json::Int64)getValueOfStorageQuota();
  } else {
    ret["storage_quota"] = Json::Value();
  }
  if (getStorageUsed()) {
    ret["storage_used"] = (Json::Int64)getValueOfStorageUsed();
  } else {
    ret["storage_used"] = Json::Value();
  }
  if (getStorageReserved()) {
    ret["storage_reserved"] = (Json::Int64)getValueOfStorageReserved();
  } else {
...
Json::Value Users::toMasqueradedJson(
  ...
  if (pMasqueradingVector.size() == 17) {
    ...
    if (!pMasqueradingVector[6].empty()) {
      if (getStorageQuota()) {
        ret[pMasqueradingVector[6]] = (Json::Int64)getValueOfStorageQuota();
      } else {
    ...
    if (!pMasqueradingVector[7].empty()) {
      if (getStorageUsed()) {
        ret[pMasqueradingVector[7]] = (Json::Int64)getValueOfStorageUsed();
      } else {
    ...
    if (!pMasqueradingVector[8].empty()) {
      if (getStorageReserved()) {
        ret[pMasqueradingVector[8]] = (Json::Int64)getValueOfStorageReserved();
      } else {
...
bool Users::validateJsonForCreation(const Json::Value &pJson,
  ...
  if (pJson.isMember("storage_quota")) {
    if (!validJsonOfField(6, "storage_quota", pJson["storage_quota"], err,
                          true))
      return false;
  }
  if (pJson.isMember("storage_used")) {
  ...
  if (pJson.isMember("storage_reserved")) {
    if (!validJsonOfField(8, "storage_reserved", pJson["storage_reserved"], err,
                          true))
      return false;
  }
  if (pJson.isMember("status")) {
  ...
  if (pJson.isMember("role")) {
    if (!validJsonOfField(10, "role", pJson["role"], err, true))
      return false;
  }
  if (pJson.isMember("login_attempts")) {
    if (!validJsonOfField(11, "login_attempts", pJson["login_attempts"], err,
                          true))
      return false;
  }
  if (pJson.isMember("locked_until")) {
  ...
  if (pJson.isMember("last_login_at")) {
    if (!validJsonOfField(13, "last_login_at", pJson["last_login_at"], err,
                          true))
      return false;
  }
  if (pJson.isMember("last_login_ip")) {
    if (!validJsonOfField(14, "last_login_ip", pJson["last_login_ip"], err,
                          true))
      return false;
  }
  if (pJson.isMember("created_at")) {
  ...
  try {
    ...
    if (!pMasqueradingVector[16].empty()) {
      if (pJson.isMember(pMasqueradingVector[16])) {
        if (!validJsonOfField(16, pMasqueradingVector[16],
                              pJson[pMasqueradingVector[16]], err, true))
          return false;
      }
    }
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err) {
  ...
  if (pJson.isMember("role")) {
    if (!validJsonOfField(10, "role", pJson["role"], err, false))
      return false;
  }
  if (pJson.isMember("login_attempts")) {
    if (!validJsonOfField(11, "login_attempts", pJson["login_attempts"], err,
  ...
  if (pJson.isMember("locked_until")) {
    if (!validJsonOfField(12, "locked_until", pJson["locked_until"], err,
                          false))
      return false;
  }
  if (pJson.isMember("last_login_at")) {
...
bool Users::validateMasqueradedJsonForUpdate(
  ...
  try {
    ...
    if (!pMasqueradingVector[16].empty() &&
        pJson.isMember(pMasqueradingVector[16])) {
      if (!validJsonOfField(16, pMasqueradingVector[16],
                            pJson[pMasqueradingVector[16]], err, false))
        return false;
    }
  } catch (const Json::LogicError &e) {
    err = e.what();
