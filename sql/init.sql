...
CREATE TABLE `folders` (
    ...
    KEY `idx_folders_user_parent_created_name_id` (`user_id`, `parent_id`, `created_at`, `name`, `id`),
    KEY `idx_folders_user_parent_updated_name_id` (`user_id`, `parent_id`, `updated_at`, `name`, `id`),
    KEY `idx_folders_user_name_id` (`user_id`, `name`, `id`),
...
CREATE TABLE `files` (
    ...
    KEY `idx_files_user_folder_size_name_id` (`user_id`, `folder_id`, `size`, `name`, `id`),
    KEY `idx_files_user_folder_created_name_id` (`user_id`, `folder_id`, `created_at`, `name`, `id`),
    KEY `idx_files_user_folder_updated_name_id` (`user_id`, `folder_id`, `updated_at`, `name`, `id`),
    KEY `idx_files_user_name_id` (`user_id`, `name`, `id`),
