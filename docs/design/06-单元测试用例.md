...
| ShareAuthFilter | test/filters/ShareAuthFilter_test.cpp | ✅ 已实现 |
...
| ConfigMgr | test/utils/ConfigMgr_test.cpp | ✅ 已实现 |
| FileHashUtil | test/utils/FileHashUtil_test.cpp | ✅ 已实现 |
| RedisKeyPrefix | test/utils/RedisKeyPrefix_test.cpp | ✅ 已实现 |
...
# 手动运行集成测试脚本
cd /path/to/disk
bash test/integration/test_auth_flow.sh
bash test/integration/test_upload_flow.sh
bash test/integration/test_download_flow.sh
# ... 其他集成测试脚本
```
