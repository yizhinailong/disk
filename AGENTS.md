...
- **Pch.hpp is enabled via `target_precompile_headers`** - keep includes compatible with precompiled header usage
...
- Library structure: No project static/dynamic library; compile source files directly into executable `disk`
...
- **DO NOT EDIT** model files in src/models/ (auto-generated files by drogon_ctl)
