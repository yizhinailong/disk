...
#### Scenario: Administrator changes status for a missing user
- **WHEN** an administrator requests a valid status change for a user ID that does not exist
...
#### Scenario: Administrator changes role for a missing user
