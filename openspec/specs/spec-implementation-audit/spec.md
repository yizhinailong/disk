# spec-implementation-audit Specification

## Purpose

Define how the project audits OpenSpec requirements against implementation and verification evidence so future work can be prioritized from an evidence-based gap matrix.
