# backend-discovery Specification

## Purpose

Capture and verify current consistency-sensitive backend behavior as a behavior-preserving contract for later refactors.
